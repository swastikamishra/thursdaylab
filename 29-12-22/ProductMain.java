...
import ShoppingKartProject1.ProductService;
	...
	public static void adminPanel()
	{
		...
		do
		{
			...
			case 2:
				...
				try
				{
				ProductServiceLab.updateProductById(Id);
				}
			 ...
			 case 3: 
				 ...
				 try
					{
					ProductServiceLab.getProductById(id);
					}
					catch(GlobalExceptionForProduct e)
					{
					System.out.println(e.getMessage());
			  ...
			  case 4: 
				  System.out.println("Enter Id to delete product: ");
					 ...
					 try
						{
						ProductServiceLab.getProductById(id1);
						}
						catch(GlobalExceptionForProduct e)
						{
						System.out.println(e.getMessage());
			 ...
			 case 5:
				  ...
				  System.out.println(" ");
				  ProductServiceLab.displayAllProduct();
				  System.out.println("=======================================================================================");
						break;
			   
			 case 6: 
				  ProductServiceLab.deleteAllProduct();
				  System.out.println("=======================================================================================");
						break;
				 
			 case 7: 
				  ProductServiceLab.displayAllOrder();
				  System.out.println("=======================================================================================");
						break;
	...
	public static void userPanel()
	{
		...
		do
		{
		    ...
		    case 1: 
			 ...
			 case 2:
				 ProductServiceLab.orderProduct ();
				 System.out.println("=======================================================================================");
					    break;
			 ...
			 case 3:
				 ...
				 try
					{
					ProductServiceLab.cancelOrderById(id2);
					}
					catch(GlobalExceptionForProduct e)
					{
					System.out.println(e.getMessage());
